...
**Note:** go-get or vendor this package as `github.com/liuliqiang/admin-controller`.
...
* `pkg/apis/admin/v1/zz_generated.deepcopy.go`
* `pkg/generated/`
...
```sh
go get -d github.com/liuliqiang/admin-controller
cd $GOPATH/src/github.com/liuliqiang/admin-controller
godep restore
```
...
`kubernetes/staging/src/github.com/liuliqiang/admin-controller` and its dependencies
...
https://github.com/kubernetes/kubernetes/blob/master/staging/src/github.com/liuliqiang/admin-controller.
